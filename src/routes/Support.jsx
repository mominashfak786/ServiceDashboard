    ...
    <>
      <div class="flex justify-center items-center mt-2">
        <div class="bg-white shadow-lg rounded-lg px-4 py-2">
          ...
          <p class="mb-1">
          If you have any questions raise ticket

          </p>
          <p class="text-lg font-medium mb-1">Email us at: fieldteam@letusmaintain.com    </p>
          <p class="mb-1">                   Service Team Helpline: xxxxxxxxxx</p>
